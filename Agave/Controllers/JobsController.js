...
'use strict';
angular.module('AgavePlatformScienceAPILib').factory('JobsController', function ($q, Configuration, HttpClient, APIHelper) {
    return {
        /**
         * Search jobs
         ...
         * @return {promise<void>}
         */
        deleteClearJobPermissions: function (jobId, naked) {
            //Assign default values
            // naked = naked || true;
